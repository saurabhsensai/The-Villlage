...
<div class="be-right-navbar">
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="ro/assets/img/avatar.png" alt="Avatar"><span class="user-name"></span></a>
 ...
 <!------------------------------------------------------------------------------------------------------------------------>
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 shadow-lg" >
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="farm.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
      </div>
      <div class="col-lg-6">
...
<br><br><br>
            ...
            <p class="history-para">This place is famous for its strawberries, mapro garden, various points, etc</p>
                ...
                <div class="gallery-container">
                    <div class="item">
                        <div class="photo">
                            <div class="img"><img src="images/mapro-garden-1067x800.jpg" alt="Gallery Image">
                            <button type="button" class="my-3 image-zoom btn btn-block btn-primary  shadow-lg" href="images/mapro-garden-1067x800.jpg">View Image</button>
                    ...
                    <div class="item">
                        <div class="photo">
                            <div class="img"><img src="wm.jpg" height="145rem" alt="Gallery Image"><br><br>
                            <button type="button" class="my-4 image-zoom btn btn-block btn-primary  shadow-lg" href="images/ElephantHeadPoint.jpg">View Image</button>
                                
                            </div>
                        </div>
                    </div>                 <div class="item">
                        <div class="photo">
                            <div class="img"><img src="images/strwberry.jpg" alt="Gallery Image">
                            <button type="button" class="my-3 image-zoom btn btn-block btn-primary  shadow-lg" href="images/strwberry.jpg">View Image</button>
                                
                            </div>
                        </div>
                    </div>                 <div class="item">
                        <div class="photo">
                            <div class="img"><img src="images/dss.PNG" height="145rem"  alt="Gallery Image"><br><br>
                            <button type="button" class="my-4 image-zoom btn btn-block btn-primary  shadow-lg" href="images/dss.PNG">View Image</button>
