            ...
            <div class="main-content container-fluid">
                <div class="splash-container forgot-password">
                    ...
                    <div class="card card-border-color card-border-color-primary shadow-lg">
                        <div class="card-header"><img class="logo-img" src="vlogo.jpeg" alt="logo" width="202" height="#{conf.logoHeight}"><span class="splash-description"><br> <b>Forgot your password?</b> </span></div>
                        <div class="card-body">
