  ...
  <div class="container"> 
    ...
    <br>
            ...
            <div class="card card-border-color card-border-color-primary shadow-lg">
              <div class="card-header"><img class="logo-img" src="hlogo.png" alt="logo" width="{conf.logoWidth}" height="90"><span class="splash-description">Please enter your home number below.</span></div>
    ...
    <div class="be-wrapper be-login bg-light">
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-primary shadow-lg">
              <div class="card-header"><img class="logo-img" src="vlogo.jpeg" alt="logo" width="{conf.logoWidth}" height="80"><h1>Log in!</h1><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
