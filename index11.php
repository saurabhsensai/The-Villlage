                    ...
                    <div class="col-md-12">
                        <div class="widget widget-fullwidth be-loading">
                            ...
                            <div class="be-spinner">
                                <svg width="40px" height="40px" viewBox="0 0 66 66" xmlns="../../../../www.w3.org/2000/svg.html">
                        ...
                        <div class="card card-table">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="user-avatar"> <img src="ro/assets/img/avatar6.png" alt="Avatar">Penelope Thornton</td>
                                            <td>Topbar dropdown style</td>
                                            <td>Aug 16, 2018</td>
                                            <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td class="user-avatar"> <img src="ro/assets/img/avatar4.png" alt="Avatar">Benji Harper</td>
                                            <td>Left sidebar adjusments</td>
                                            <td>Jul 15, 2018</td>
                                            <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td class="user-avatar"> <img src="ro/assets/img/avatar5.png" alt="Avatar">Justine Myranda</td>
                                            <td>Main structure markup</td>
                                            <td>Jul 28, 2018</td>
                                            <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td class="user-avatar"> <img src="ro/assets/img/avatar3.png" alt="Avatar">Sherwood Clifford</td>
