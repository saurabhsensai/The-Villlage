...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update hospital set hospitalStatus='Recovered' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update hospital set hospitalStatus='Dead' where id='$id'");
	$msg="Category deleted ";
}
// <!--------------------------------------------------------------------------------------------->
// Code for restore
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update hospital set hospitalStatus='Active' where id='$id'");
...
<div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-expand fixed-top be-top-header">
		  ...
		  <div class="page-title"><span>List of villagers</span></div>
...
<!------------------------------------------------------------------------------------------------------------------------------------->
                  ...
                  <li class="parent"><a href=""><i class="icon mdi mdi-male-female"></i><span>Villagers</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="villagers.php">All Villagers</a>
                      </li>
...
?>
                ...
                <div class="card-header card-header-divider">Upload Villagers To Database<span class="card-subtitle">Choose Villagers Excel to upload to database</span></div>
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">List of villagers
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table3">
                    ...
                    <?php 
$query=mysqli_query($con,"Select id,VillagersFirstName,VillagersLastName,VillagersAge,VillagersGender,VillagePopulationCategory,VillagersLiteracy,VillagersProfession,AdmitDate,UpdationDate from  villagers where hospitalStatus='Active'");
$cnt=1;
...
?>              
                      <tr class="gradeA">
                        ...
                        <td><?php echo htmlentities($row['VillagersFirstName']);?></td>
                        <td><?php echo htmlentities($row['VillagersLastName']);?></td>
                        <td><?php echo htmlentities($row['VillagersGender']);?></td>
                        <td><?php echo htmlentities($row['VillagersAge']);?></td>
                        <td><?php echo htmlentities($row['VillagersLiteracy']);?></td>
                        <td><?php echo htmlentities($row['VillagePopulationCategory']);?></td>
                        <td><?php echo htmlentities($row['VillagersProfession']);?></td>
                        
                        <td class="center">


                        <a class="btn btn-space btn-secondary hover" href="Editvillagersinfo.php?cid=<?php echo htmlentities($row['id']);?>">Edit info</a>
