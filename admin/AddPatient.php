...
$Age=$_POST['Age'];
$gender = $_POST['gender'];
$PatientStatus = $_POST['Active'];



$query=mysqli_query($con,"insert into Patient(PatientName,Age,gender,PatientStatus) values('$category','$Age','$gender','Active')");
if($query)
{
$msg="Category created ";
header("Location: ActivePatients.php");
}
else{
...
<div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-expand fixed-top be-top-header">
		  ...
		  <div class="page-title"><span>Add Patient Data</span></div>
...
?>
                ...
                <div class="card-header card-header-divider">Upload Patients To Database<span class="card-subtitle">Choose Patients Excel to upload to database</span></div>
                <div class="card-body">
...
<div class="col-md-12 ">  <div class="container my-5">
                    ...
                    <div class="col-md-12">
                        <div class="card card-border-color card-border-color-primary shadow">
                            <div class="card-header card-header-divider">Add Patient Entries <span class="card-subtitle">Patient Details</span></div>
                            <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Patient's Age :</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3" name="Age" type="text">
                      </div>
                    </div>
                    ...
                    <label class="custom-control custom-radio custom-control-inline">
                      ...
                      <div class="col-sm-6">
                        <p class="text-right">
                          ...
                          <button class="btn btn-space btn-primary" type="submit" href="EditPatientinfo.php?cid=<?php echo htmlentities($row['id']);?>"  name="submit">Submit</button>
