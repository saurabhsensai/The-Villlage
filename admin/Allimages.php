...
<div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-expand fixed-top be-top-header">
		  ...
		  <div class="page-title"><span>Manage Village gallery</span></div>
...
<!------------------------------------------------------------------------------------------------------------------------------------->
				  ...
				  <li class="parent"><a href=""><i class="icon mdi mdi-collection-image"></i><span>Village Gallery</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="Allimages.php">Manage Images</a>
                      </li>
...
<!---------------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Village Gallery</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Tables</a></li>
                        <li class="breadcrumb-item active">Village Gallery</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">Village Gallery
                            ...
                            <?php
$db = mysqli_connect("localhost", "root", "", "photo_gallery");
$qry = "SELECT * FROM photo_gallery";
...
if($type=='temp'){
  ...
  $id=$_GET['id'];
  if($saurabh=='deactive'){
    $update_status_sql="DELETE FROM photo_gallery where id='$id'";
...
<script src="ro/assets/lib/bootstrap/dist/js/bootstrap.bundle.min.js"
      type="text/javascript"></script>
    <script src="ro/assets/js/app.js" type="text/javascript"></script>
    <script src="ro/assets/lib/jquery.niftymodals/js/jquery.niftymodals.js"
      type="text/javascript"></script>
