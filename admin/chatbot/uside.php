...
<a href="#" class="btn btn-sm btn-primary mr-4">Connect</a>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src="profile.png" alt="Admin" class="rounded-circle p-1" width="110">
...
<div class="row align-items-md-stretch mx-2">
      ...
      <div class="text-dark  shadow border rounded-3">
         <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a type="button" class="btn bg-primary btn-lg mx-4" href="mail.php"> Complaint Mail</a>
          <br><br>
        </div>
      </div>
    </div><br>
...
<?php require_once('config.php'); ?>
 <?php require_once('inc/header.php') ?>
    ...
    <script src="ro/assets/lib/prettify/prettify.js" type="text/javascript"></script>
