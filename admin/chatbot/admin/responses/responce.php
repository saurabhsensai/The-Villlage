...
<!---------------------------------------------------------------------------------------------------------------------------------->
                      ...
                      <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">Secondary <span class="icon-dropdown mdi mdi-chevron-down"></span></button>
                      ...
                      <a class="dropdown-item"  href="?page=responses/manage&id=<?php echo $row['id'] ?>">Edit</a>
                      <a class="dropdown-item" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Delete</a>
